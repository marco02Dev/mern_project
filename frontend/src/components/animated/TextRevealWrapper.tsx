...
import { TextReaveal } from "../../animations/text-reveal.animation";
import { ReactElement } from "react";
import { useInView } from "../../hooks/useViewIn";

const Wrapper = styled.div<{$revealText: boolean, $absolute?: string, $addiniotalAnimation?: RuleSet, $width?: string, $height?: string, $left: boolean, $right?: boolean}>`
    overflow-y: hidden;

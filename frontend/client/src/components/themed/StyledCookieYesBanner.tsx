...
import { useThemeColors, ThemeColors } from "@client/hooks/theme/useThemeColors";
import { CookieYesStylesType } from "@client/styles/cookie-yes.style";
import { useCookieYes } from "@client/hooks/theme/useCookieYes";

...
import { determineTextFontSizeAndLineHeight, StyledTextSizes } from "@shared/utils/components/determine-text-font-size-and-line-height.util";
...
import { defaultTextTag } from "@shared/config/styled-text.config";
